                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <p>Siempre estamos tratando de brindarle un servicio completo.<br>
                            Puede ver sus citas previamente reservadas.<br><br>
                            </p>
                            <a href="citas.php" class="non-style-link"><button class="btn-primary btn" style="width:30%">Ver mis citas</button></a>
                            <br>
                            <br>
                        </td>
                    </tr>
                        ...
                        <table border="0" width="100%"">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p id="anim" style="font-size: 20px;font-weight:600;padding-left: 40px;">Sus próximas sesiones hasta la siguiente semana</p>
                                    <center>
                                        ...
                                        <tbody>
                                            ...
                                            $sqlmain= "select schedule.scheduleid,schedule.title,doctor.docname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join doctor on schedule.docid=doctor.docid  where schedule.scheduledate>='$today' and schedule.scheduledate<='$nextweek' order by schedule.scheduledate desc"; 
                                                ...
                                                if($result->num_rows==0){
                                                    ...
                                                    <a class="non-style-link" href="cronograma.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Mostrar citas &nbsp;</font></button>
                                                    </a>
                                                    </center>
                                                    <br><br><br><br>
                                                    </td>
